...
{
    //Used throughout the game for general game events (game started, game ended, life lost, etc.)
    ...
    // Handles event management. Can be used to broadcast events throughout the game, to tell that something's happened.
    [ExecuteAlways]

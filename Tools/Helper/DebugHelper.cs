...
namespace GameKit.Tools
{
    ...
    {
        public static ConsoleHelper _console;
        ...
        public static void DebugLogTime(object message, string color = "", int timePrecision = 3, bool displayFrameCount = true)
        {
            ...
            output += "<color=#f9a682>[" + TimeHelper.FloatToTimeString(Time.time, false, true, true, true) + "]</color> ";
        ...
        public static void InstantiateOnScreenConsole(int fontSize = 10)
        {
            ...
            if (_console == null)
            {
                ...
                newGameObject.name = "Console";
                _console = newGameObject.AddComponent<ConsoleHelper>();
        ...
        public static void DrawRectangle(Rect rectangle, Color color)
        {
            ...
            DebugHelper.DrawRectangle(pos, color, scale);
        }

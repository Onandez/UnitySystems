...
namespace GameKit.Tools
{
    ...
    {
        // Possible states for a button. Can be used in a state machine.
        ...
        public class IMButton
        {
            ...
            public virtual void TriggerButtonPressed()
            {
                ...
                {
                    State.ChangeState(InputHelper.ButtonStates.ButtonPressed);
                }
                else
                {
                    ButtonPressedMethod();
            ...
            public virtual void TriggerButtonUp()
            {
                ...
                {
                    State.ChangeState(InputHelper.ButtonStates.ButtonUp);
                }
                else
                {
                    ButtonUpMethod();

...
namespace GameKit.Tools
{
    ...
    public class LoadingSceneManager : MonoBehaviour
    {
        ...
        {
            _tween = new TweenType(Tween.TweenCurve.EaseOutCubic);
        ...
        {
            Time.timeScale = 1f;
            LoadingProgressBar.GetComponent<Image>().fillAmount = MathsHelper.Approach(LoadingProgressBar.GetComponent<Image>().fillAmount, _fillTarget, Time.deltaTime * ProgressBarSpeed);
        }
        ...
        protected virtual void LoadingComplete()
        {
            ...
            StartCoroutine(FadeHelper.FadeCanvasGroup(LoadingProgressBar, 0.1f, 0f));
            StartCoroutine(FadeHelper.FadeCanvasGroup(LoadingAnimation, 0.1f, 0f));
            StartCoroutine(FadeHelper.FadeCanvasGroup(LoadingCompleteAnimation, 0.1f, 1f));
        }
    }
}
